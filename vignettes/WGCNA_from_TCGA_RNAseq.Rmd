...
Melanoma RNAseq data were downloaded as expression estimates per gene (RNAseq2 level 3 data) from the [TCGA data portal](https://tcga-data.nci.nih.gov/tcga/). 
...
[^8]: S Falcon and R Gentleman. “Using GOstats to test gene lists for GO term association”. In: Bioinfor- matics 23.2 (Jan. 2007), pp. 257–258.
